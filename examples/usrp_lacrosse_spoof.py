...
# Generated: Fri Mar  6 19:24:03 2015
##################################################
...
class usrp_lacrosse_spoof(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.01, 1024, 1, "")
        ...
        (self.blocks_unpack_k_bits_bb_0).set_min_output_buffer(1)
        (self.blocks_unpack_k_bits_bb_0).set_max_output_buffer(1024)
